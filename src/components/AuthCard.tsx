      ...
      <form className="glass animate-fade-up rounded-[2rem] p-6 sm:p-8" aria-label={title}>
        ...
        <div className="mt-8 space-y-4">
          ...
          <label className="block">
            ...
            <input className="focus-ring w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-ink shadow-sm" type="email" placeholder="you@school.edu" autoComplete="email" />
          </label>
          <label className="block">
